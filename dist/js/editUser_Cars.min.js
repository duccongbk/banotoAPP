...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var idUser = urlParams.get('id_user');
  var choosen = urlParams.get('choosen'); // Lấy tham số choosen từ URL
...
function _getUser() {
  _getUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(idUser) {
    var response, userData, errorMessage;
